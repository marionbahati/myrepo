...
export class AppComponent {
  ...
  register() {
    ...
    this.http.post("http://localhost:8080/api/v1/customer/save",
  ...
  UpdateRecords() {
    ...
    this.http.put("http://localhost:8080/api/v1/customer/update", 
    bodyData, { responseType: 'text' }).subscribe((resultData: any) => {
      console.log(resultData);
  ...
  setDelete(data: any) {
    ...
    this.http.delete("http://localhost:8084/api/v1/customer/deletecustomer" 
    + "/" + data.customerid, { responseType: 'text' }).subscribe((resultData: any) => {
      console.log(resultData);

...
export class FooterComponent {
  ...
  goBack() {
    if (this.route == "/individuelleZusammenstellung" || this.route == "/cubeIndividuell" ||
      this.route == "/videoIndividuell" || this.route == "/themenfilme") {
      this.router.navigateByUrl('/individuell');

    } if (this.route == "/testShow") {
      this.router.navigateByUrl('/test');

    } if (this.route == "/show") {
      this.router.navigateByUrl('/seite3');

      // } if (this.route == "/cubeIndividuell") {
      //   this.router.navigateByUrl('/individuell');
      // } if (this.route == "/videoIndividuell") {
      //   this.router.navigateByUrl('/individuell');
      // } if (this.route == "/themenfilme") {
      //   this.router.navigateByUrl('/individuell');
      // }
    }

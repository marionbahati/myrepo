...
function Component(arg0: { selector: string; standalone: boolean; imports: any[]; templateUrl: string; styleUrl: string; }): (target: typeof NewgraphComponent, context: ClassDecoratorContext<typeof NewgraphComponent>) => void | typeof NewgraphComponent {
